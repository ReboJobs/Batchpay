...
{
    public class TenantTimeoutJsonExceptionFilter : ExceptionFilterAttribute
    {
        public override Task OnExceptionAsync(ExceptionContext context)
        {
            ...
            if (isTenantActive == false)
            {
                ...
                context.Result = new JsonResult(new { success = false, sessionTimeOut = true, error = "Tenant is disconnected" });
            }
